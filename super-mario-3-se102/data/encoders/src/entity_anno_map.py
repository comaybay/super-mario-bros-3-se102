...
world_entity_anno_map = {
    ...
    (2, 0): EntityCode.PIPE_WARP_UP_1_IN,
    (3, 0): EntityCode.PIPE_WARP_UP_2_IN,
    (4, 0): EntityCode.PIPE_WARP_UP_1_OUT,
    (5, 0): EntityCode.PIPE_WARP_UP_2_OUT,
    ...
    (2, 2): EntityCode.PIPE_WARP_DOWN_1_IN,
    (3, 2): EntityCode.PIPE_WARP_DOWN_2_IN,
    (4, 2): EntityCode.PIPE_WARP_DOWN_1_OUT,
    (5, 2): EntityCode.PIPE_WARP_DOWN_2_OUT,
