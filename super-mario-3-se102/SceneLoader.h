...
private:
	static std::string ParseWorldProperties(std::ifstream& file, std::string& sceneType, std::string& worldType, std::string& playerTransitionType, Utils::Dimension<int>& dim, D3DCOLOR& bgColor, std::string& prevScenePath);
