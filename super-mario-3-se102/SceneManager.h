...
private:
	...
	static std::string ParseAndAddWallsEntities(std::ifstream& file, LPEntityManager entityManager);
	static std::string ParseAndAddOtherEntities(std::ifstream& file, LPEntityManager entityManager);
